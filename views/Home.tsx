          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="w-full lg:w-1/2 relative">
              <div className="aspect-[4/5] bg-white border border-gray-100 shadow-2xl relative z-10 overflow-hidden">
                <img
                  ...
                  alt="Featured Artisan Spotlight"
            ...
            <div className="w-full lg:w-1/2 space-y-10">
              <div>
                ...
                <h2 className="text-6xl font-serif italic text-[#273134]">T’s Studio.</h2>
              </div>
              ...
              <div className="space-y-4">
                <p className="text-sm text-gray-400 italic">Based in Sedona, our featured artisan specializes in hand-hammered sterling silver and high-grade American turquoise.</p>
                <Link
                  to="/shop"
